...
def test_get_conversation(mock_requests, mock_load_dotenv):
...
@patch('requests.get')
def test_get_conversation_usd(mock_requests_get):
    transaction = {
         "id": 41428829,
         "state": "EXECUTED",
...
@patch('requests.get')
def test_get_conversation_eur(mock_requests_get):
    transaction = {
         "id": 41471229,
         "state": "EXECUTED",
